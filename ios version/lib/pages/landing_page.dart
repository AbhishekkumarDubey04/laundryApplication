...
class _LandingPageState extends State<LandingPage> {
  final List<Map<String, dynamic>> services = [
    ...
    },
    {
      ...
      'desc': 'Crisp crease control using high-pressure steam. Delivered on hangers.',
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        actions: [
          // iOS-style icon button for theme toggle
          CupertinoButton(
      ...
      body: CustomScrollView(
        physics: PlatformUtils.scrollPhysics, // iOS bouncing scroll
        slivers: [
          SliverPadding(
            padding: EdgeInsets.fromLTRB(
                16, 16, 16, 16 + safePadding.bottom),
            sliver: SliverList(
              delegate: SliverChildListDelegate([
                    ...
                    children: [
                      ...
                      SizedBox(
                        ...
                        child: CupertinoButton(
                          ...
                          child: const Text('Schedule Free Pickup',
                              style: TextStyle(
                                  fontWeight: FontWeight.bold,
                                  color: Colors.white)),
                        ),
                ...
                Row(
                  ...
                  children: [
                    _buildStatItem('15,000+', 'Orders Completed', theme),
                    _buildStatItem('4.9 ★', 'App Store Rating', theme),
                    _buildStatItem('24 Hours', 'Express Delivery', theme),
                  ],
                ),
                ...
                SizedBox(
                  ...
                  child: ListView(
                    ...
                    children: testimonials
                        .map((t) => _buildTestimonialCard(t, theme, isDark))
                        .toList(),
                  ),
                ),
                const SizedBox(height: 32),
  ...
  Widget _buildStatItem(String val, String desc, ThemeData theme) {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.start,
      children: [
        Text(val,
  ...
  Widget _buildServiceCard(
      Map<String, dynamic> s, ThemeData theme, bool isDark) {
    return Card(
  ...
  Widget _buildTestimonialCard(
      Map<String, String> t, ThemeData theme, bool isDark) {
    return Container(
      width: 280,
  ...
  Widget _buildFaqItem(
      Map<String, String> faq, ThemeData theme, bool isDark) {
    return Theme(
      ...
      child: ExpansionTile(
        ...
        onExpansionChanged: (_) => PlatformUtils.hapticLight(),
        children: [
          Padding(
            padding: const EdgeInsets.all(16.0),
            child: Text(faq['a']!,
