...
class ApiService {
  ...
  ApiService._internal() {
    ...
    // Android emulators need 10.0.2.2 to reach host machine localhost.
  ...
  Future<Response> updateOrderPaymentStatus(int id, String paymentStatus) async {
    return dio.put('/orders/$id/payment-status',
        data: {'payment_status': paymentStatus});
  }

  // Payment operations
  Future<Response> createPayment(int orderId, String method) async {
    return dio.post('/payments/create',
  ...
  Future<Response> validateCoupon(String code, double amount) async {
    return dio.post('/coupons/validate',
